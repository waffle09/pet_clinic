...
// echo $pet_name;
$contact = filter_var(trim($_POST['date']));
...
$conn->query("UPDATE `pet` SET `client_id` = $id, `name` = $cl_name, `kind` = $adress, `date_of_birth` = $contact WHERE `pet`.`record_number` = $num_red_pet");
