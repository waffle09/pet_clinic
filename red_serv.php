...
<h3 style="font-family: 'Indie Flower', cursive; margin: 30px; padding-left: 90px; color: red;">Редагування</h3>
        <form style="margin: 30px;" method="post" action="serv_red.php">
    <!--**** save_user.php - это адрес обработчика.  То есть, после нажатия на кнопку "Зарегистрироваться", данные из полей  отправятся на страничку save_user.php методом "post" ***** -->
    
    <label style="padding-right:104px; font-size: 130%;">service id<br></label>
    <input style="padding-right: 0px; font-size: 130%;" name="id" type="number" size="30" maxlength="15">
    </p>
<p>
    <label style="padding-right:142px; font-size: 130%;">name<br></label>
    <input style="padding-right: 0px; font-size: 130%;" name="name" type="text" size="20" maxlength="50">
    </p>
<p>
<p>
    <label style="padding-right:146px; font-size: 130%;">price<br></label>
    <input style="padding-right: 0px; font-size: 130%;" name="price" type="number" size="10" maxlength="30">
    </p>
...
<h3 style="font-family: 'Indie Flower', cursive; margin: 30px; padding-left: 90px; color: red;">Видалення</h3>
        <form style="margin: 30px;" method="post" action="serv_del.php">    
    <label style="padding-right:104px; font-size: 130%;">service id<br></label>
