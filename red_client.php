...
<h3 style="font-family: 'Indie Flower', cursive; margin: 30px; padding-left: 90px; color: red;">Редагування</h3>
        <form style="margin: 30px;" method="post" action="client_red.php">
    <!--**** save_user.php - это адрес обработчика.  То есть, после нажатия на кнопку "Зарегистрироваться", данные из полей  отправятся на страничку save_user.php методом "post" ***** -->
    
    <label style="padding-right:104px; font-size: 130%;">record_number<br></label>
    <input style="padding-right: 0px; font-size: 130%;" name="num_red" type="number" size="25" maxlength="15">
    </p>
<p>
    <label style="padding-right:164px; font-size: 130%;">client_id<br></label>
    <input style="padding-right: 0px; font-size: 130%;" name="id" type="number" size="25" maxlength="50">
    </p>
<p>
<p>
    <label style="padding-right:189px; font-size: 130%;">name<br></label>
    <input style="padding-right: 45px; font-size: 130%;" name="cl_name" type="text" size="15" maxlength="50">
    </p>
    <label style="padding-right:177px; font-size: 130%;">adress<br></label>
    <input style="padding-right: 0px; font-size: 130%;" name="adress" type="text" size="20" maxlength="50">
    </p>
<p>
    <label style="padding-right:172px; font-size: 130%;">contact<br></label>
    <input style="padding-right: 0px; font-size: 130%;" name="contact" type="text" size="20" maxlength="50">
    </p>
...
<h3 style="font-family: 'Indie Flower', cursive; margin: 30px; padding-left: 90px; color: red;">Видалення</h3>
        <form style="margin: 30px;" method="post" action="client_del.php">    
    <label style="padding-right:104px; font-size: 130%;">record_number<br></label>
    <input style="padding-right: 0px; font-size: 130%;" name="num_del" type="text" size="20" maxlength="15">
    </p>
